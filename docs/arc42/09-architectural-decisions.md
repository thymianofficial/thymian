...
| [ADR-0008](adr/0008-package-naming-conventions.md)                             | Package naming conventions (`plugin-*`, `rules-*`, `common-*`)             | Accepted | 2026-04-09 | —                                                                                                                      |
| [ADR-0009](adr/0009-rule-system-as-core-concern.md)                            | Rule system as a core concern                                              | Accepted | 2026-04-09 | —                                                                                                                      |
...
| [ADR-0021](adr/0021-report-diff-document-and-gating.md)                        | `report diff` emits a non-`Report` diff document and gates on diff changes | Accepted | 2026-08-26 | —                                                                                                                      |
