...
| ---------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| Usability        | Learnability     | It should be easy to understand how to use Thymian, without extensive instruction reading. Users should recognize patterns in the interaction with Thymian from other tools.                                                      | 10.2.1        | [ADR-0003](adr/0003-plugins-allow-streaming.md)                                                   |
