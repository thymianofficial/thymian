...
| Name                                | Type                  | Description                                   | Required |
| ----------------------------------- | --------------------- | --------------------------------------------- | -------- |
| [**text**](#formatterstext)         | <nobr>`object`</nobr> | Configuration for the text formatter<br/>     |          |
...
| **path**        | <nobr>`string`</nobr>  | File path where the plain text report will be saved<br/>        |          |
