...
- [`thymian sampler validate`](#thymian-sampler-validate)
...
FLAGS
  --cwd=<value>         [default:
                        /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/plugin-sampler]
...
FLAGS
  --cwd=<value>              [default: /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/
                             plugin-sampler] Set current working directory.
...
FLAGS
  ...
  --cwd=<value>  [default:
                 /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/plugin-sampler] Set
...
```
USAGE
  $ thymian sampler validate [--json] [--verbose] [--debug] [--guidance] [--log-level
    ...
    <value>] [--cwd <value>] [--suppress-feedback] [--validate-specs] [--full-diffs] [--for-path <value>]

FLAGS
  --cwd=<value>       [default:
                      /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/plugin-sampler]
                      Set current working directory.
  --for-path=<value>  Validate a single generated artifact by its relative path (e.g. meta.json) and show its full diff.
                      Note: the full artifact set is still regenerated internally, so this scopes the output, not the
                      work.
  --full-diffs        Show the full diff for every out-of-sync artifact instead of a summary.
...
_See code: [dist/cli/commands/sampler/validate.js](https://github.com/thymianofficial/thymian/blob/v0.0.0-PLACEHOLDER/dist/cli/commands/sampler/validate.js)_
<!-- commandsstop -->
