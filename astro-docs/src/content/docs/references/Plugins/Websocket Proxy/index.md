...
Thereby, the Websocket Proxy Plugin provides an interface similar to the `ThymianEmitter` for remote plugins. If you just want to connect a plugin via Websockets, see [here](/guides/remote-plugins/how-to-connect-remote-plugins/). If you want to implement a remote plugin using Websockets, see [here](/guides/remote-plugins/how-to-develop-a-remote-plugin/).
