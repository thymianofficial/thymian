...
This error typically indicates internal data corruption or a bug in how samples are being written or transformed. If you encounter this error, try regenerating your samples:
