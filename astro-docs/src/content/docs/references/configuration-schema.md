...
Rule set package with an explicit profile selection.

**Properties**

| Name        | Type                  | Description                                                                                                                         | Required |
| ----------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | -------- |
| **name**    | <nobr>`string`</nobr> | Rule set package name.<br/>                                                                                                         | yes      |
| **profile** | <nobr>`string`</nobr> | Recommended rule-configuration profile to apply. Defaults to `recommended`.<br/>Enum: `"recommended"`, `"strict"`, `"minimal"`<br/> | no       |
