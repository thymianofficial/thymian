...
- [`thymian explain rule RULENAME`](#thymian-explain-rule-rulename)
...
- [`thymian report convert`](#thymian-report-convert)
...
USAGE
  $ thymian analyze [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    ...
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--validate-traffic-source]

FLAGS
  --cwd=<value>                   [default: /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/pack
                                  ages/thymian] Set current working directory.
...
BASE FLAGS
  ...
  --sort-reports-by=<option>           Group report findings by rule, endpoint, or severity (default: endpoint). Affects
                                       the CLI report and any configured reporter that supports grouping.
...
USAGE
  $ thymian config show [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    ...
    type:location...] [--traffic type:location...] [--rule-set package-name...] [--rule-severity off|error|warn|hint]
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--yaml]

FLAGS
  --cwd=<value>  [default: /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/thymian] Set
...
## `thymian explain rule RULENAME`

Explain a single rule: what it checks, why it matters, and how to act on it. Any rule in the configured rule sets can be explained regardless of its severity, so the inherited --rule-severity flag has no effect here.

```
USAGE
  $ thymian explain rule RULENAME [--verbose] [--debug] [--guidance] [--log-level
    ...
    [--rule-severity off|error|warn|hint] [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout
    <value>] [--cwd <value>] [--suppress-feedback] [--validate-specs]

ARGUMENTS
  RULENAME  Canonical rule id, e.g. rfc9110/<rule-name> (as shown by `thymian rules list`).
...
DESCRIPTION
  Explain a single rule: what it checks, why it matters, and how to act on it. Any rule in the configured rule sets can
  be explained regardless of its severity, so the inherited --rule-severity flag has no effect here.

EXAMPLES
  $ thymian explain rule rfc9110/origin-server-should-send-501-response-for-unrecognized-method
```

_See code: [dist/commands/explain/rule.js](https://github.com/thymianofficial/thymian/blob/v0.0.0-PLACEHOLDER/dist/commands/explain/rule.js)_
...
USAGE
  $ thymian generate config [--suppress-feedback] [--cwd <value>] [--interactive] [--output <value>] [--for-spec
    type:location...] [--for-report type:location...]

FLAGS
  --cwd=<value>                  [default: /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packa
                                 ges/thymian] Set current working directory.
  --for-report=type:location...  External report input in the format <type>:<location> (e.g. spectral:./report.json).
                                 Adds a reports entry for `thymian report convert`.
  ...
  --output=<value>               Output path for the generated configuration file. Defaults to thymian.config.yaml in
...
EXAMPLES
  ...
  $ thymian generate config --for-spec openapi:./petstore.yaml --for-report spectral:./report.json
```
...
FLAGS
  --cjs             Generate rule using CommonJS syntax. With --output, the file is written as .cjs.
  --cwd=<value>     [default: /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/thymian]
...
EXAMPLES
  ...
  $ thymian generate rule --cjs --output src/rules/my-rule.rule.cjs
```
...
## `thymian report convert`

Convert external tool reports into a canonical Thymian report.

```
USAGE
  $ thymian report convert [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    [--config <value>] [--autoload] [--plugin <value>...] [--option <plugin>.<path>=<value>...] [--spec
    type:location...] [--traffic type:location...] [--rule-set package-name...] [--rule-severity off|error|warn|hint]
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--report type:location...]

FLAGS
  --cwd=<value>              [default:
                             /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/thymian]
                             Set current working directory.
  --report=type:location...  External report input in the format <type>:<location> (e.g. spectral:./report.json).
...
EXAMPLES
  $ thymian report convert --report spectral:./report.json

  $ thymian report convert --report spectral:./report.json --spec openapi:./api.yaml
```

_See code: [dist/commands/report/convert.js](https://github.com/thymianofficial/thymian/blob/v0.0.0-PLACEHOLDER/dist/commands/report/convert.js)_
...
USAGE
  $ thymian request [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    ...
    type:location...] [--traffic type:location...] [--rule-set package-name...] [--rule-severity off|error|warn|hint]
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--validate]
...
USAGE
  $ thymian rules list [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    ...
    type:location...] [--traffic type:location...] [--rule-set package-name...] [--rule-severity off|error|warn|hint]
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--type static|analytics|test|informational...] [--to-csv <value>]

FLAGS
  --cwd=<value>       [default:
                      /Users/qupaya/Code/thymian-internal/.worktrees/thymian/story-725-5-docs/packages/thymian] Set
                      current working directory.
...
USAGE
  $ thymian test [--verbose] [--debug] [--guidance] [--log-level trace|debug|info|warn|error|silent]
    ...
    type:location...] [--traffic type:location...] [--rule-set package-name...] [--rule-severity off|error|warn|hint]
    [--sort-reports-by rule|endpoint|severity] [--timeout <value>] [--idle-timeout <value>] [--cwd <value>]
    [--suppress-feedback] [--validate-specs] [--target-url <value>]
