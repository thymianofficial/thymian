...
<div className="mt-12">
  <CardGrid stagger minimal>
    <Card title="Quick Start" icon="rocket">
      ...
      <LinkButton href="/guides/example/" variant="minimal" icon="right-arrow">Get Started</LinkButton>
    </Card>
    ...
    <Card title="Plugin Ecosystem" icon="puzzle">
      ...
      <LinkButton href="/plugins/" variant="minimal" icon="right-arrow">Explore Plugins</LinkButton>
    </Card>
    ...
    <Card title="Documentation" icon="open-book">
      ...
      <LinkButton href="/introduction/" variant="minimal" icon="right-arrow">Read Docs</LinkButton>
    </Card>
