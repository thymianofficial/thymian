...
export default httpRule(
  ...
  .type(
    ...
    'Identifying quoted-pairs inside a comment requires knowing which response fields carry comment syntax (e.g. Server, User-Agent) and fully parsing the comment grammar; without a dependable curated set this cannot be checked without false positives.',
  )
