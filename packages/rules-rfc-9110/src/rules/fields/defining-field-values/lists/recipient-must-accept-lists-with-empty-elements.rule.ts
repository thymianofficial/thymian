...
export default httpRule(
  ...
  .severity('error')
  // Informational (unobservable): whether a recipient accepts a list containing
  // empty elements is internal parsing behaviour with no observable signal, and
  // Thymian cannot inject such a list into the peer's inbound path to probe it.
  .type('informational')
