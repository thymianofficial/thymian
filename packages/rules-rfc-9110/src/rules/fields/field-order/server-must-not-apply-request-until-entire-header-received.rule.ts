...
export default httpRule(
  ...
  .severity('error')
  // Informational (unobservable): whether a server defers applying a request
  // until the full header section arrives is an internal timing/ordering
  // decision with no distinguishable signal in a completed transaction that
  // Thymian records.
  .type('informational')
