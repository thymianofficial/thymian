...
export default httpRule(
  ...
  .type(
    ...
    "Flagging a repeated field line requires knowing whether that field's definition permits list recombination (#(values)); this needs a complete per-field registry of list-typed fields that the framework does not have, so a generic check would misfire on legitimately repeatable fields.",
  )
