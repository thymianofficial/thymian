...
export default httpRule('rfc9110/recipient-should-ignore-unrecognized-fields')
  .severity('warn')
  // Ignoring an unrecognized field is a non-action internal to the recipient;
  // there is no distinguishable response signal that reveals whether the peer
  // ignored a field or never saw it.
  .type('informational')
