...
export default httpRule(
  ...
  .severity('error')
  // We need to make this informational for now since we don't have the functionality to send invalid request yet
  // To test this rule against real HTTP server, we would have to establish a TCP connection ourselves and manually construct the HTTP request.
  .type('informational')
