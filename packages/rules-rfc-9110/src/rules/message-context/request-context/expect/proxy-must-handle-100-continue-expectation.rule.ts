...
export default httpRule('rfc9110/proxy-must-handle-100-continue-expectation')
  .severity('hint')
  // Informational: both permitted proxy behaviours (respond with a final
  // status, or forward toward the origin) are conforming and require proxy
  // role attribution plus forwarding correlation to distinguish; surfaced as
  // guidance only.
  .type('informational')
