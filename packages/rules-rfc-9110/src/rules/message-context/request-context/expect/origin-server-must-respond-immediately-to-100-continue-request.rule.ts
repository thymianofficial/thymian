...
export default httpRule(
  ...
  .severity('hint')
  // "immediate" is a timing requirement with no wire signature, and
  // distinguishing an origin server's own response from a proxy-generated one
  // needs role attribution.
  .type('informational')
