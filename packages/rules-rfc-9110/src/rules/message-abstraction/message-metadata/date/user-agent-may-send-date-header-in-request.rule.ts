...
// This is a request-side permissive "MAY". A user agent MAY send a Date header
// field in a request, and generally will not. Both sending and omitting Date
// are conformant, so there is no non-conformant condition to detect.
