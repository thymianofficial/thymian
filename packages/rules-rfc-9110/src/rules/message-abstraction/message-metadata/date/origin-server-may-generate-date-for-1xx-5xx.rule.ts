...
// This is a pure permissive "MAY". An origin server MAY generate a Date header
// field in 1xx and 5xx responses, but it is equally conformant to omit it.
// There is therefore no non-conformant condition to detect — neither presence
// nor absence of Date on a 1xx/5xx response is a violation.
