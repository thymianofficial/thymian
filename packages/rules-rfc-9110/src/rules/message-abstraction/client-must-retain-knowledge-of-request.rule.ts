...
// Informational (outcome 2): this MUST governs how a client internally parses
// and caches a response (it must keep the corresponding request in mind, e.g.
// HEAD responses look like GET responses but must not be parsed as such). That
// is internal client behavior with no observable on-the-wire condition the rule
