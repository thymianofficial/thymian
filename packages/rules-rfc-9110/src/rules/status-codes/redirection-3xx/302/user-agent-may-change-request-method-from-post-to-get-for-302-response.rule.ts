...
export default httpRule(
  ...
  .type(
    ...
    'A MAY describing an internal user-agent decision (whether to change POST to GET when following a 302). Both behaviors are conformant, so there is no non-conformant condition.',
  )
