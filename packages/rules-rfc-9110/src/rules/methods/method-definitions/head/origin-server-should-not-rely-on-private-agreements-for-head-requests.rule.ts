...
// "Relying on a private (out-of-band) agreement" to receive HEAD content is a
// property of the server's design intent, not of any observable HTTP message.
// Nothing in a request, response, or recorded trace reveals such reliance, so
// the SHOULD NOT cannot be checked.
