...
export default httpRule('rfc9110/content-location-201-response-semantics')
  .severity('hint')
  // Informational: whether Content-Location matching (or differing from)
  // Location in a 201 is CORRECT depends on what the returned content actually
  // represents - a semantic fact the engine cannot judge. Either arrangement is
  // valid on the wire; verified by understanding the resource semantics.
  .type('informational')
