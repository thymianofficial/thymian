...
export default httpRule(
  ...
  .severity('warn')
  // The SHOULD applies only once server-internal preconditions all hold (Range
  // supported for the resource, valid specifier with a supported unit, and
  // satisfiable against the selected representation) — none observable. 200 (Range
  // ignored), 416, and 304 are all conformant.
  .type('informational')
