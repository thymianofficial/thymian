...
export default httpRule(
  ...
  // valid only in `analyze` — in `test` the request is generated by Thymian, not
  // a real client. Reads the Range request header VALUES on AnalyzeContext's
  // validateHttpTransactions; appliesTo includes 'user-agent' to match HAR
  // requests.
  .type('analytics')
