...
/**
 * Permissive client-side MAY: a client is allowed to send If-Unmodified-Since on
 * a GET. Neither sending nor omitting the header is non-conformant. Being
 * client-side, even a meaningful check could never belong in `test`. `appliesTo`
 * is scoped to the client roles.
 */
