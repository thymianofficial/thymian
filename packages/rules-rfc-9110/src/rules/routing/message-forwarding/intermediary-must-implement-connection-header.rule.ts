...
export default httpRule('rfc9110/intermediary-must-implement-connection-header')
  .severity('error')
  // Informational: "implement the Connection header" is a capability requirement; conformance shows up only in downstream forwarding behavior, not as a single observable message artifact.
  .type('informational')
