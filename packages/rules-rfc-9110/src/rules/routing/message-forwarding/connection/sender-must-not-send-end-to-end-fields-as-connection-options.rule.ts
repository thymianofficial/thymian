...
export default httpRule(
  ...
  .severity('error')
  .type('analytics')
  // Marking an end-to-end field as hop-by-hop causes it to be stripped by an intermediary that should have forwarded it, corrupting what the next hop believes the message actually says — the same Connection-header integrity the RFC never calls "smuggling".
