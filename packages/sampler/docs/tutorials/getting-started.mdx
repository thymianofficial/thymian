---
title: Getting Started with @thymian/sampler
description: Getting started tutorial for @thymian/sampler
---
...
Adjust the `source` path to point to your OpenAPI specification file.
...
✔ Run transactions gainst your API

---

## Next Steps

### Explore More Hook Capabilities

- [How to Write Hooks](../how-to/write-hooks.mdx)
- [How to Make Requests in Hooks](../how-to/make-requests-in-hooks.mdx)
- [How to Skip or Fail Tests](../how-to/skip-and-fail-tests.mdx)

### Understand the Concepts

- [Explanation: Hook System](../explanation/hook-system.md)
- [Explanation: Hierarchical File-Based Approach](../explanation/hierarchical-approach.md)

### Reference Documentation

- [CLI Reference](../references/cli.md)
- [Hooks API Reference](../references/hooks-api.md)
- [Request Format Reference](../references/request-format.md)
