---
title: The Concept of the File-based Samples
...
For this reason, an approach is required that is both **scalable** and **transparent**. The `@thymian/sampler` plugin provides such an approach based on a filesystem structure.
...
from the Thymian format and should never be touched or modified manually.
